...
def attack(char_name: str, char_class: str) -> str:
    """
    Рассчитывает и возвращает урон наносимый персонажем
    взависимости от класса персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Рассчитывает и возвращает защиту первонажа
    взависимости от класса персонажа.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Рассчитывает и возвращает специальное умение
    взависимости от класса персонажа.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Определяет класс персонажа и тренирует его."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    Принимает на вход выбор игроком персонажа и
    описывает возможности персонажа.
    """
    approve_choice: str = ''
    char_class: str = ''
